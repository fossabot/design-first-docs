...
<div id="team-members">
  <div class="team">
    ...
    <p>
      The development of design-first and its ecosystem is guided by an awesome team, some of whom have chosen to be featured below.
    </p>
  ...
  <div class="team">
    ...
    <p>
      Some members of the design-first community have so enriched it, that they deserve special mention. We've developed a more intimate relationship with these key partners, often coordinating with them on upcoming features and news.
    </p>
...
(function () {
  ...
  var team = [{
    ...
    languages: ['en'],
    github: 'adam-hanna',
    twitter: 'adam_m_hanna',
    linkedin: 'adam-hanna-89188b28',
    work: {
      role: 'Creator',
      org: 'design-first'
    },
